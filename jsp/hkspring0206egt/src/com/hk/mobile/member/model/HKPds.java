...
public class HKPds implements Serializable {
	...
	public HKPds(int seq, String id, String title, String content,
	...
	public HKPds(String id, String title, String content, String filename) {
		super();
		this.id = id;
		this.title = title;
		this.content = content;
