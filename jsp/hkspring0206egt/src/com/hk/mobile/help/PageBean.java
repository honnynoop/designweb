...
public class PageBean implements Serializable{
	...
	public String toString() {
		return "PageBean [startPage=" + startPage + ", curPage=" + curPage
				+ ", curendPage=" + curendPage + ", countPerPage="
				+ countPerPage + ", totalCount=" + totalCount + ", totalPage="
				+ totalPage + ", startBlock=" + startBlock + ", countPerBlock="
				+ countPerBlock + ", totalBlock=" + totalBlock
				+ ", curBlockPage=" + curBlockPage + ", curendBlock="
				+ curendBlock + ", lastBlockPage=" + lastBlockPage
				+ ", lastBlockStartPage=" + lastBlockStartPage + "]";
	}
}